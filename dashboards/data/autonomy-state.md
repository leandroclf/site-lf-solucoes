...
Atualizado em: `2026-04-08T00:47:29.383917Z`
...
## Repos estagnados
- `lf-openalex-enrichment-mvp` — stale | age 271.6h | fix(openalex): normalize shim file endings
- `lf-wikidata-entity-graph` — stale | age 385.7h | Merge pull request #4 from leandroclf/feature/issue-002-grafo-de-entidades-com-wikidata-para-normaliza-o
- `lf-worldbank-risk-pricing` — stale | age 286.8h | feat(worldbank): add telemetry and contract governance
