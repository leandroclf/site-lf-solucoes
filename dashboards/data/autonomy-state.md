...
Atualizado em: `2026-04-02T08:17:25.676234Z`
...
- `Revisar lf-wikidata-entity-graph` — Repo estagnado há 249.2h: Merge pull request #4 from leandroclf/feature/issue-002-grafo-de-entidades-com-wikidata-para-normaliza-o | tipo: `refresh-stale-repo`
...
## Repos estagnados
- `lf-openalex-enrichment-mvp` — stale | age 135.1h | fix(openalex): normalize shim file endings
- `lf-wikidata-entity-graph` — stale | age 249.2h | Merge pull request #4 from leandroclf/feature/issue-002-grafo-de-entidades-com-wikidata-para-normaliza-o
- `lf-worldbank-risk-pricing` — stale | age 150.3h | feat(worldbank): add telemetry and contract governance
