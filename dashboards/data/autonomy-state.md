...
Atualizado em: `2026-04-07T20:17:29.021612Z`
...
## Repos estagnados
- `lf-openalex-enrichment-mvp` — stale | age 267.1h | fix(openalex): normalize shim file endings
- `lf-wikidata-entity-graph` — stale | age 381.2h | Merge pull request #4 from leandroclf/feature/issue-002-grafo-de-entidades-com-wikidata-para-normaliza-o
- `lf-worldbank-risk-pricing` — stale | age 282.3h | feat(worldbank): add telemetry and contract governance
