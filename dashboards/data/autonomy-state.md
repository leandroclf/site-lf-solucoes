...
Atualizado em: `2026-03-29T23:17:38.272215Z`
...
- `Revisar lf-wikidata-entity-graph` — Repo estagnado há 168.2h: Merge pull request #4 from leandroclf/feature/issue-002-grafo-de-entidades-com-wikidata-para-normaliza-o | tipo: `refresh-stale-repo`
...
## Repos estagnados
- `lf-openalex-enrichment-mvp` — stale | age 54.1h | fix(openalex): normalize shim file endings
- `lf-wikidata-entity-graph` — stale | age 168.2h | Merge pull request #4 from leandroclf/feature/issue-002-grafo-de-entidades-com-wikidata-para-normaliza-o
- `lf-worldbank-risk-pricing` — stale | age 69.3h | feat(worldbank): add telemetry and contract governance
