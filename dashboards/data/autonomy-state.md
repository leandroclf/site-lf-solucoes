...
Atualizado em: `2026-04-05T12:17:28.478713Z`
...
## Repos estagnados
- `lf-openalex-enrichment-mvp` — stale | age 211.1h | fix(openalex): normalize shim file endings
- `lf-wikidata-entity-graph` — stale | age 325.2h | Merge pull request #4 from leandroclf/feature/issue-002-grafo-de-entidades-com-wikidata-para-normaliza-o
- `lf-worldbank-risk-pricing` — stale | age 226.3h | feat(worldbank): add telemetry and contract governance
