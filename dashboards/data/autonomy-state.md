...
Atualizado em: `2026-04-02T08:47:24.939173Z`
...
- `Revisar lf-wikidata-entity-graph` — Repo estagnado há 249.7h: Merge pull request #4 from leandroclf/feature/issue-002-grafo-de-entidades-com-wikidata-para-normaliza-o | tipo: `refresh-stale-repo`
...
## Repos estagnados
- `lf-openalex-enrichment-mvp` — stale | age 135.6h | fix(openalex): normalize shim file endings
- `lf-wikidata-entity-graph` — stale | age 249.7h | Merge pull request #4 from leandroclf/feature/issue-002-grafo-de-entidades-com-wikidata-para-normaliza-o
- `lf-worldbank-risk-pricing` — stale | age 150.8h | feat(worldbank): add telemetry and contract governance
