...
Atualizado em: `2026-03-30T01:17:39.027866Z`
...
- `Revisar lf-wikidata-entity-graph` — Repo estagnado há 170.2h: Merge pull request #4 from leandroclf/feature/issue-002-grafo-de-entidades-com-wikidata-para-normaliza-o | tipo: `refresh-stale-repo`
...
## Repos estagnados
- `lf-openalex-enrichment-mvp` — stale | age 56.1h | fix(openalex): normalize shim file endings
- `lf-wikidata-entity-graph` — stale | age 170.2h | Merge pull request #4 from leandroclf/feature/issue-002-grafo-de-entidades-com-wikidata-para-normaliza-o
- `lf-worldbank-risk-pricing` — stale | age 71.3h | feat(worldbank): add telemetry and contract governance
