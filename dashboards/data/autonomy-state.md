...
Atualizado em: `2026-04-05T08:47:30.355586Z`
...
## Repos estagnados
- `lf-openalex-enrichment-mvp` — stale | age 207.6h | fix(openalex): normalize shim file endings
- `lf-wikidata-entity-graph` — stale | age 321.7h | Merge pull request #4 from leandroclf/feature/issue-002-grafo-de-entidades-com-wikidata-para-normaliza-o
- `lf-worldbank-risk-pricing` — stale | age 222.8h | feat(worldbank): add telemetry and contract governance
